...
I am a Software Engineer specializing in the **.NET Ecosystem** and **Azure Infrastructure**. I help companies scale without the "cloud tax" by architecting high-efficiency systems that slash computing costs.

> **"I believe a SLOW APP is a NON-WORKING APP!"**

I focus on high-efficiency system design, database query tuning, and DSA optimizations that can save businesses thousands—or millions—in cloud expenditures.

I’m looking to help teams build intelligent, production-ready products that are as cost-effective as they are fast.   
